...
CREATE TABLE "users" ("id" char(26) NOT NULL, "name" varchar(20) NOT NULL, "email" VARCHAR NOT NULL, PRIMARY KEY ("id"));
CREATE TABLE "accounts" ("id" char(26) NOT NULL, "user_id" VARCHAR NOT NULL, "name" varchar(10), "password_hash" VARCHAR NOT NULL, "balance" float8 NOT NULL, "currency_id" VARCHAR NOT NULL, "last_updated_at" TIMESTAMPTZ NOT NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "authentications" ("user_id" VARCHAR NOT NULL, "password_hash" VARCHAR NOT NULL, PRIMARY KEY ("user_id"));
