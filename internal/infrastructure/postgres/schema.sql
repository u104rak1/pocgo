...
CREATE TABLE "accounts" ("id" char(26) NOT NULL, "user_id" VARCHAR NOT NULL, "name" varchar(10), "password_hash" VARCHAR NOT NULL, "balance" float8 NOT NULL, "currency_id" VARCHAR NOT NULL, "updated_at" TIMESTAMPTZ NOT NULL, "deleted_at" TIMESTAMPTZ, PRIMARY KEY ("id"));
CREATE TABLE "transactions" ("id" char(26) NOT NULL, "account_id" VARCHAR NOT NULL, "receiver_account_id" VARCHAR, "type" varchar(20) NOT NULL, "amount" float8 NOT NULL, "currency_id" VARCHAR NOT NULL, "transaction_at" TIMESTAMPTZ NOT NULL, PRIMARY KEY ("id"));
CREATE TABLE "authentications" ("user_id" VARCHAR NOT NULL, "password_hash" VARCHAR NOT NULL, "deleted_at" TIMESTAMPTZ, PRIMARY KEY ("user_id"));
